...
const addPurchases = (arr) => {
  ...
  //.purchasePrice is added to currentValue because each item in the object has a purchase price and the instructions want us to add the purchase prices.
};
...
//why does this work? what role is answerSoFar playing in this function?
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
